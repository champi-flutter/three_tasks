...
mixin _$VLabeledTask {
  ...
  @override
  String toString() {
    return 'VLabeledTask(label: $label, labelId: $labelId, dailyIdList: $dailyIdList, weeklyIdList: $weeklyIdList, monthlyIdList: $monthlyIdList, yearlyIdList: $yearlyIdList)';
  }
}
