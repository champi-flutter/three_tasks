...
//     required TaskList<EWeeklyTask> updatedETaskList,
//   }) =>
...
//
//           // todo キャッシュへのアクセスはリポジトリで行う（2026/09/09）＞＞
...
//   }) _analyzeTaskInfo(List<EWeeklyTask> taskInfo) {
...
//         // 変更を受けるタスクの ID
//         final int changedTaskId = eTask.id;
//         // 変更保存用に情報を組み込む
...
//       // ID が -2 かどうか
//       final bool isPlaceholder2 = eTask.id == -2;
//       // インスタンスのパラメータが placeholder2 から変化しているかどうか（@freezed）
//       final bool isChanged =
//           eTask != VWeeklyTask.placeholder2(vTask.week.firstDateOfWeek);
...
//   Future<Result<List<EWeeklyTask>, Exception>> _reflectEntryInPlaceholder(
//     Map<int, Date> valuedPlaceholder,
//   )
//   // 折りたたみ用
//   async {
...
//       final Result<List<EWeeklyTask>, Exception> created =
