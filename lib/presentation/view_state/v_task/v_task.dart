...
abstract class VWeeklyTask with WeeklyTaskBase, _$VWeeklyTask implements VTask {
  ...
  factory VWeeklyTask.placeholder(Date targetDate) => VWeeklyTask(
      title: "",
      week: UniqueWeek.fromDate(currentDate: targetDate, firstDate: targetDate),
      id: -1,
      isChecked: false,
      labelId: -1,
      isFetched: true,
...
/// 月単位のタスククラス
@freezed
abstract class VMonthlyTask
    with MonthlyTaskBase, _$VMonthlyTask
    implements VTask {
