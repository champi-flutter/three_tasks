...
String _$saveTaskChangesUseCaseHash() =>
    r'a80ee68b9a366f3bbedf33e907944b2ff171e842';
...
String _$saveWeeklyTaskChangesUseCaseHash() =>
    r'0f94fdee4ff3b766b791ff1f738e8e151518c63a';
...
String _$watchDailyTasksUseCaseHash() =>
    r'86dacbb14914e41057a1913f2379cfa3521fcb14';

/// 週単位タスクの監視フロー

@ProviderFor(watchWeeklyTasksUseCase)
const watchWeeklyTasksUseCaseProvider = WatchWeeklyTasksUseCaseProvider._();

/// 週単位タスクの監視フロー

final class WatchWeeklyTasksUseCaseProvider extends $FunctionalProvider<
    WatchWeeklyTasksUseCase,
    WatchWeeklyTasksUseCase,
    WatchWeeklyTasksUseCase> with $Provider<WatchWeeklyTasksUseCase> {
  /// 週単位タスクの監視フロー
  const WatchWeeklyTasksUseCaseProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
          name: r'watchWeeklyTasksUseCaseProvider',
          isAutoDispose: true,
          dependencies: null,
          $allTransitiveDependencies: null,
        );
  ...
  @override
  String debugGetCreateSourceHash() => _$watchWeeklyTasksUseCaseHash();

  @$internal
  @override
  $ProviderElement<WatchWeeklyTasksUseCase> $createElement(
          $ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  WatchWeeklyTasksUseCase create(Ref ref) {
    return watchWeeklyTasksUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(WatchWeeklyTasksUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<WatchWeeklyTasksUseCase>(value),
    );
  }
}

String _$watchWeeklyTasksUseCaseHash() =>
    r'b729db15a04ce04a32bbc8801daf8e0b6b697eb4';

/// 日単位タスクのアクセス通知フロー

@ProviderFor(notifyDailyTasksAccessUseCase)
const notifyDailyTasksAccessUseCaseProvider =
    NotifyDailyTasksAccessUseCaseProvider._();

/// 日単位タスクのアクセス通知フロー

final class NotifyDailyTasksAccessUseCaseProvider extends $FunctionalProvider<
        NotifyDailyTasksAccessUseCase,
        NotifyDailyTasksAccessUseCase,
        NotifyDailyTasksAccessUseCase>
    with $Provider<NotifyDailyTasksAccessUseCase> {
  /// 日単位タスクのアクセス通知フロー
  const NotifyDailyTasksAccessUseCaseProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
          name: r'notifyDailyTasksAccessUseCaseProvider',
          isAutoDispose: true,
          dependencies: null,
          $allTransitiveDependencies: null,
        );
  ...
  @override
  String debugGetCreateSourceHash() => _$notifyDailyTasksAccessUseCaseHash();

  @$internal
  @override
  $ProviderElement<NotifyDailyTasksAccessUseCase> $createElement(
          $ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  NotifyDailyTasksAccessUseCase create(Ref ref) {
    return notifyDailyTasksAccessUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(NotifyDailyTasksAccessUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride:
          $SyncValueProvider<NotifyDailyTasksAccessUseCase>(value),
    );
  }
}
...
const discardDraftUseCaseProvider = DiscardDraftUseCaseProvider._();

/// 下書き破棄フロー

final class DiscardDraftUseCaseProvider extends $FunctionalProvider<
    DiscardDraftUseCase,
    DiscardDraftUseCase,
    DiscardDraftUseCase> with $Provider<DiscardDraftUseCase> {
  /// 下書き破棄フロー
  const DiscardDraftUseCaseProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
          name: r'discardDraftUseCaseProvider',
          isAutoDispose: true,
          dependencies: null,
          $allTransitiveDependencies: null,
        );
  ...
  @override
  String debugGetCreateSourceHash() => _$discardDraftUseCaseHash();

  @$internal
  @override
  $ProviderElement<DiscardDraftUseCase> $createElement(
          $ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  DiscardDraftUseCase create(Ref ref) {
    return discardDraftUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(DiscardDraftUseCase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<DiscardDraftUseCase>(value),
    );
  }
}

String _$discardDraftUseCaseHash() =>
    r'e268ce459aeea3802564c53f14ade42a900c991f';
...
String _$dailyTasksPresenterHash() =>
    r'f28a92fe7091c76a3b8c9455fdfb0f28dcc0bea3';

/// 週単位タスク監視反映ポート

@ProviderFor(weeklyTasksPresenter)
const weeklyTasksPresenterProvider = WeeklyTasksPresenterProvider._();

/// 週単位タスク監視反映ポート

final class WeeklyTasksPresenterProvider extends $FunctionalProvider<
    WeeklyTasksPresenter,
    WeeklyTasksPresenter,
    WeeklyTasksPresenter> with $Provider<WeeklyTasksPresenter> {
  /// 週単位タスク監視反映ポート
  const WeeklyTasksPresenterProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
          name: r'weeklyTasksPresenterProvider',
          isAutoDispose: true,
          dependencies: null,
          $allTransitiveDependencies: null,
        );
  ...
  @override
  String debugGetCreateSourceHash() => _$weeklyTasksPresenterHash();

  @$internal
  @override
  $ProviderElement<WeeklyTasksPresenter> $createElement(
          $ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  WeeklyTasksPresenter create(Ref ref) {
    return weeklyTasksPresenter(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(WeeklyTasksPresenter value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<WeeklyTasksPresenter>(value),
    );
  }
}

String _$weeklyTasksPresenterHash() =>
    r'289376b1ee10c2ce4a2b18f4940488f0cc4bd7c7';
